...
public:
  ...
  HalfEdge(Point *a1) : p1(a1), p2(nullptr), p(nullptr), n(nullptr), t(nullptr), f(nullptr) {}
  HalfEdge(Point *a1, Point *a2) : p1(a1), p2(a2), p(nullptr), n(nullptr), t(nullptr), f(nullptr) {}
  HalfEdge(Point *a1, Point *a2, HalfEdge *prev, HalfEdge *next, HalfEdge *twin) : p1(a1), p2(a2), p(prev), n(next), t(twin), f(nullptr) {}
